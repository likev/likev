...
if($_GET['history']){
//$history_rain_url = "http://www.hnaws.com/infodisplay.asp?Cityflag=HNLY&InfoT=historical&DispT=intable&StartT=2011-2-28%2020:00&EndT=2011-3-1%2015:32";
	$rain_info_url = "http://www.hnaws.com/infodisplay.asp?Cityflag=HNLY&InfoT=historical&DispT=intable&StartT=".rawurlencode($_GET['startTime'])."&EndT=".rawurlencode($_GET['endTime']);	
	$match_patten = "#<tr class='tContent'><td>(HN[A-Z0-9]+\d+)</td><td>\S+</td><td>\d+</td><td>(\d+\.?\d*)</td></tr>#";
}
else{
	$rain_info_url = "http://www.hnaws.com/infodisplay.asp?Cityflag=HNLY&InfoT=realtime&DispT=intable&StartT=undefined&EndT=undefined";
}
